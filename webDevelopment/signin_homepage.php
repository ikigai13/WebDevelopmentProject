  ...
  <head>
    ...
    <nav>
      ...
      <ul class="nav-links">
        ...
        <li><a href='userlogout.php' ;" id="myButton" class="float-left submit-button">Log Out</a></li>
      </ul>
      <div class="burger">
        <div class="line1"></div>
        <div class="line2"></div>
    ...
    <div class="wrapper">
      <div class="card">
        <img src="images/tokyoueno.jpg" alt="">
        <div class="info">
    ...
    <div class="wrapper">
      <div class="card">
        <img src="images/Murakami Colourless.jpg" alt="">
        <div class="info">
          <h1>Colourless</h1>
    ...
    <div class="wrapper">
      <div class="card">
        <img src="images/Looking for alaska.jpg" alt="">
        <div class="info">
    ...
    <div class="wrapper">
      <div class="card">
        <img src="images/Tokyo_Ghoul_volume_1_cover.jpg" alt="">
        <div class="info">
          <h1>Tokyo Ghoul</h1>
